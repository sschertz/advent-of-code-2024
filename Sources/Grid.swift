...
public struct Grid<T: Equatable> {
  ...
  public func changeDirection(
    from fromDirection: Direction, to toDirection: Direction
  ) -> Direction {
  ...
  public enum Direction: CaseIterable {
    ...
    func getNextCoordinate(from start: (c: Int, r: Int), by distance: Int = 1)
      -> (c: Int, r: Int)
    {
      let (c, r) = start
    ...
    public func turn(to directionToTurn: Direction) -> Direction {
